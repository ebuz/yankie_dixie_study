...
export const PARTNER_SELECTION = 'PARTNER_SELECTION';
export const PARTNER_UNSELECTION = 'PARTNER_UNSELECTION';
export const SPEAKER_RECORDING = 'SPEAKER_RECORDING';
export const INSTRUCTIONS_PLAYED = 'INSTRUCTIONS_PLAYED';
export const FINISHED_SELECTION = 'FINISHED_SELECTION';
...
export const ENDED_EARLY = 'ENDED_EARLY,';
...
export const MIC_PARTNER_REDO_CHECK = 'MIC_PARTNER_REDO_CHECK';
